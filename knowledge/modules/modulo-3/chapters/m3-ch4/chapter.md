...
| Will | Going to |
|------|----------|
| **Spontaneous decisions** (in the moment) | **Plans already decided** |
| I'll have pizza. (decides now) | I'm going to study tonight. (already planned) |
| **Predictions (opinion/belief)** | **Predictions (evidence)** |

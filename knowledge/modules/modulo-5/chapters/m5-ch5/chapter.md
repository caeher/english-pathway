...
- The house **will be** built. (future)
- The house **is being** built. (present continuous)

### Affirmative, Negative, Interrogative
| Form | Example |
|------|---------|
| **Affirmative** | The car **is made** in Japan. |
| **Negative** | The car **isn't made** in Japan. / The letter **hasn't been sent** yet. |
...
|-------|---------|-------------------|
| Present Simple | am / is / are | + made, done, sold... |
| Past Simple | was / were | + stolen, built, written... |
| Present Perfect | has/have been | + repaired, seen, finished... |
| Future | will be | + built, opened, sent... |
| Present Continuous | am/is/are being | + built, cleaned, used... |
| Past Continuous | was/were being | + cleaned, repaired, watched... |

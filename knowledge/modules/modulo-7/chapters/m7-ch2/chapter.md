...
| **also** | neutral | She **also** speaks French. |
| **in addition** | formal | **In addition**, the hotel has a pool. |
| **furthermore** | formal | **Furthermore**, the study shows... |
...
| **however** | formal | I like tea. **However**, I don't drink it often. |
| **although / though** | neutral | **Although** it rained, we went out. |
| **despite / in spite of** | formal | **Despite** the rain, we went out. |
...
| **since** | **Since** it was late, we left. |
| **as** | **As** he was tired, he went to bed. |
...
| **therefore** | It's raining. **Therefore**, the game is cancelled. |
...
| **in order to** | She studies hard **in order to** pass. |
| **so that** | I saved money **so that** I could travel. |

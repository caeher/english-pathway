...
| **break a leg** | buena suerte | You have a show tonight? **Break a leg!** |
...
| **cost an arm and a leg** | costar mucho dinero | That car **cost an arm and a leg**. |
...
| **think outside the box** | think creatively | We need to **think outside the box** to solve this. |
...
| **kill two birds with one stone** | kill two birds with one stone | I combined the meeting. **Kill two birds with one stone**. |
...
| Break a leg | Good luck! / A lot of shit! |
| A piece of cake | Piece of cake / Very easy |
